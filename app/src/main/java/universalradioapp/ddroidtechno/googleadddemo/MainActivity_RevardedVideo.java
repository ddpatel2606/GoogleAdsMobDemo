 ...
 */
public class MainActivity_RevardedVideo extends Activity implements RewardedVideoAdListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_rewarded_video);
    ...
    public void onRewarded(RewardItem reward) {
        Toast.makeText(this,String.format(Locale.ENGLISH," onRewarded! currency: %s amount: %d", reward.getType(),
                        reward.getAmount()),
